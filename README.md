...
- **Long-Term Funds**: Track pension, study fund (קרן השתלמות), and investment balances with one manual entry per month (re-entering the same fund + month updates it). Each fund gets a balance-over-time chart. Funds carry Company Name and Fund Name (both required) plus an optional Fund Number, and any field can be edited later from the Manage Funds table.
